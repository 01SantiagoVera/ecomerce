      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Su paquete llegará en 3-5 días hábiles a su lugar de recogida o
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿El ajuste no es del todo correcto? No se preocupe: cambiaremos
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ...
              Sin preguntas: haremos nuestro mejor esfuerzo para asegurarnos de
              que su devolución sea sin problemas.
            </p>
          </div>
        </div>
      </div>
